...
int main()
{
    ...
    Mat0=goujianfangzhen(590.785,-28.9789,674.886,0.705178,-0.24221,0.660404,-0.0890254);
   // cout<<"方阵MAT0:= \n"<<Mat0<<endl;
    Mat1=Mat0.inverse();
    //cout<<"方阵MAT0逆矩阵:= \n"<<Mat1<<endl;
    Mat2=goujianfangzhen(645.163,-143.655,424.309,0.233098,0.965985,0.108365,0.0282011);
    //cout<<"方阵MAT2:= \n"<<Mat2<<endl;
    Mat3=Mat1*Mat2;
    RPY(Mat3);
    cout<<"变换矩阵Mat3:= \n"<<Mat3<<endl;
    ...
    Mat4=goujianfangzhen(590.8,-28.9711,674.856,0.708007,-0.241856,0.65735,-0.0901255);
    //cout<<"方阵MAT4:= \n"<<Mat4<<endl;
    Mat5=Mat4.inverse();
    //cout<<"方阵MAT5逆矩阵:= \n"<<Mat5<<endl;
    Mat6=goujianfangzhen(647.33,-143.668,424.77,0.233584,0.965852,0.107336,0.032364);
    //cout<<"方阵MAT6:= \n"<<Mat6<<endl;
    Mat7=Mat5*Mat6;
    RPY(Mat7);
    cout<<"变换矩阵Mat7:= \n"<<Mat7<<endl;
    ...
    Mat9=goujianfangzhen(617.8,-28.9681,678.811,0.665121,-0.247045,0.70072,-0.0746594);
    Mat10=Mat9.inverse();
    Mat11=goujianfangzhen(642.379,-143.656,423.587,0.226314,0.965976,0.121864,-0.0286476);
    Mat12=Mat10*Mat11;
    RPY(Mat11);
    cout<<"变换矩阵Mat12:= \n"<<Mat12<<endl;
