...
int main()
{
   ...
   // cout<<"方阵MAT0:= \n"<<Mat0<<endl;
    Mat1=Mat0.inverse();
    //cout<<"方阵MAT0逆矩阵:= \n"<<Mat1<<endl;
    Mat2=goujianfangzhen(441.438,-216.645,218.004,0.278583,0.951062,0.109587,0.0765756);
    //cout<<"方阵MAT2:= \n"<<Mat2<<endl;
    Mat3=Mat1*Mat2;
    RPY(Mat3);
    cout<<"变换矩阵Mat3:= \n"<<Mat3<<endl;
    ...
    Mat5=Mat4.inverse();
    //cout<<"方阵MAT5逆矩阵:= \n"<<Mat5<<endl;
    Mat6=goujianfangzhen(531.672,143.487,392.25,0.278693,0.95102,0.109569,0.0767225);
    //cout<<"方阵MAT6:= \n"<<Mat6<<endl;
    Mat7=Mat5*Mat6;
    RPY(Mat3);
    cout<<"变换矩阵Mat7:= \n"<<Mat7<<endl;
    ...
    Mat10=Mat9.inverse();
    Mat11=goujianfangzhen(534.284,13.456,316.254,0.278733,0.95101,0.109592,0.0766628);
    Mat12=Mat10*Mat11;
    RPY(Mat12);
    cout<<"变换矩阵Mat12:= \n"<<Mat12<<endl;
    ...
    Mat14=Mat13.inverse();
    Mat15=goujianfangzhen(632.275,-185.265,423.246,0.278843,0.950953,0.10988,0.0765577);
    Mat16=Mat14*Mat15;
    RPY(Mat16);
    cout<<"变换矩阵Mat16:= \n"<<Mat16<<endl;
    ...
    Mat18=Mat17.inverse();
    Mat19=goujianfangzhen(633.952,-91.6807,281.982,0.278835,0.950962,0.109877,0.0764748);
    Mat20=Mat18*Mat19;
    RPY(Mat20);
    cout<<"变换矩阵Mat20:= \n"<<Mat20<<endl;
