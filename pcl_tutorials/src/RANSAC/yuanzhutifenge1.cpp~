...
{  // All the objects needed
 ...
 reader.read ("/home/xu/Desktop/cpp_lianxi/src/pcl_tutorials/src/RANSAC/table_scene_mug_stereo_textured.pcd", *cloud);  std::cerr << "PointCloud has: " << cloud->points.size () << " data points." << std::endl;  
...
// 从点云中抽取分割的处在平面上的点集  
 ...
 writer.write ("/home/xu/Desktop/cpp_lianxi/src/pcl_tutorials/src/RANSAC/table_scene_mug_stereo_textured_plane.pcd", *cloud_plane, false);  
...
// Write the cylinder inliers to disk  
   ...
   std::cerr << "Can't find the cylindrical component." << std::endl;  else
 {
     ...
     writer.write ("/home/xu/Desktop/cpp_lianxi/src/pcl_tutorials/src/RANSAC/table_scene_mug_stereo_textured_cylinder.pcd", *cloud_cylinder, false);
 }  
 //程序可视化
    ...
    //pcl::visualization::CloudViewer viewer2("pcd viewer");//窗口显示名字
    //viewer2.showCloud(cloud_plane); 
    //sleep(100);
    pcl::visualization::CloudViewer viewer3("pcd viewer");//窗口显示名字
    viewer3.showCloud(cloud_cylinder); 
    //sleep(100);
